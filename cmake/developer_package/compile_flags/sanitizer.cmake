...
if (ENABLE_SANITIZER)
    ...
    elseif(OV_COMPILER_IS_CLANG)
        set(SANITIZER_COMPILER_FLAGS "${SANITIZER_COMPILER_FLAGS} -fsanitize=address -fsanitize-address-use-after-return=always -fsanitize-address-use-after-scope -fno-omit-frame-pointer -fstack-protector-strong -fno-optimize-sibling-calls -O1 -fno-inline -g -fsanitize-blacklist=${OpenVINO_SOURCE_DIR}/tests/sanitizers/asan/ignore.txt")
